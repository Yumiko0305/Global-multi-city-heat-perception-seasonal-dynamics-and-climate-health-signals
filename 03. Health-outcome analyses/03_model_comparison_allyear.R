## =============================================================================
## Script 03: Model comparison — full-year sensitivity analysis
##
## Identical specification to Script 01 but uses ALL 365 days (no warm-season
## restriction). This is a pre-specified sensitivity analysis to assess whether
## results are robust to the seasonal filter.
##
## Input:  final_dat.rds
## Output: which_better_allyear/Death.xlsx
...
dir.create('which_better_allyear', showWarnings = FALSE)
writexl::write_xlsx(plot_dat, path = 'which_better_allyear/Hospitalization.xlsx')
...
ggsave(p, filename = 'which_better_allyear/Hospitalization_barplot.pdf', width = 10, height = 8)
...
ggsave(p, filename = 'which_better_allyear/Hospitalization_heatmap.pdf', width = 10, height = 8)
...
dir.create('which_better_allyear', showWarnings = FALSE)
writexl::write_xlsx(plot_dat, path = 'which_better_allyear/Death.xlsx')
...
ggsave(p, filename = 'which_better_allyear/Death_barplot.pdf', width = 10, height = 8)
...
ggsave(p, filename = 'which_better_allyear/Death_heatmap.pdf', width = 10, height = 8)
...
writexl::write_xlsx(plot_dat, path = 'which_better_allyear/ED.xlsx')
...
ggsave(p, filename = 'which_better_allyear/ED_barplot.pdf', width = 10, height = 8)
...
ggsave(p, filename = 'which_better_allyear/ED_heatmap.pdf', width = 10, height = 8)
